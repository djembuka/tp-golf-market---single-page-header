...
(function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        ...
        var MMCQ = function() {
            var sigbits = 5, rshift = 8 - sigbits, maxIterations = 1e3, fractByPopulations = .75;
            ...
            function vboxFromPixels(pixels, histo) {
                var rmin = 1e6, rmax = 0, gmin = 1e6, gmax = 0, bmin = 1e6, bmax = 0, rval, gval, bval;
                pixels.forEach(function(pixel) {
                    rval = pixel[0] >> rshift;
                    gval = pixel[1] >> rshift;
                    bval = pixel[2] >> rshift;
    ...
    2: [ function(require, module, exports) {
        (function() {
            var CanvasImage, Swatch, Vibrant, bind = function(fn, me) {
                return function() {
            ...
            window.Swatch = Swatch = function() {
                ...
                Swatch.prototype._ensureTextColors = function() {
                    if (!this.yiq) {
                        return this.yiq = (this.rgb[0] * 299 + this.rgb[1] * 587 + this.rgb[2] * 114) / 1e3;
                    }
                };
                return Swatch;
            }();
            window.Vibrant = Vibrant = function() {
                ...
                Vibrant.prototype.TARGET_DARK_LUMA = .26;
                Vibrant.prototype.MAX_DARK_LUMA = .45;
                Vibrant.prototype.MIN_LIGHT_LUMA = .55;
                Vibrant.prototype.TARGET_LIGHT_LUMA = .74;
                Vibrant.prototype.MIN_NORMAL_LUMA = .3;
                Vibrant.prototype.TARGET_NORMAL_LUMA = .5;
                Vibrant.prototype.MAX_NORMAL_LUMA = .7;
                Vibrant.prototype.TARGET_MUTED_SATURATION = .3;
                Vibrant.prototype.MAX_MUTED_SATURATION = .4;
                Vibrant.prototype.TARGET_VIBRANT_SATURATION = 1;
                Vibrant.prototype.MIN_VIBRANT_SATURATION = .35;
...
(function(e) {
    ...
    s.style.lineHeight = "", e.fn.autosize = function(i) {
        return this.length ? (i = e.extend({}, o, i || {}), s.parentNode !== document.body && e(document.body).append(s), 
        this.each(function() {
            function o() {
                var t, o = window.getComputedStyle ? window.getComputedStyle(u, null) : !1;
                o ? (t = u.getBoundingClientRect().width, (0 === t || "number" != typeof t) && (t = parseInt(o.width, 10)), 
            ...
            function a() {
                var a = {};
                if (t = u, s.className = i.className, s.id = i.id, d = parseInt(p.css("maxHeight"), 10), 
            ...
            function r() {
                var e, n;
                t !== u ? a() : o(), s.value = !u.value && i.placeholder ? (p.attr("placeholder") || "") + i.append : u.value + i.append, 
                s.style.overflowY = u.style.overflowY, n = parseInt(u.style.height, 10), s.scrollTop = 0, 
                s.scrollTop = 9e4, e = s.scrollTop, d && e > d ? (u.style.overflowY = "scroll", 
                e = d) : (u.style.overflowY = "hidden", c > e && (e = c)), e += w, n !== e && (u.style.height = e + "px", 
            ...
            c = Math.max(parseInt(p.css("minHeight"), 10) - w || 0, p.height()), p.css({
                overflow: "hidden",
                overflowY: "hidden",
                wordWrap: "break-word"
            ...
            }) : p.on("input.autosize", r), i.resizeDelay !== !1 && e(window).on("resize.autosize", l), 
...
(function($) {
    $.fn.magnify = function(oOptions) {
        ...
        var $that = this, $html = $("html"), init = function(el) {
            var $image = $(el), $anchor = $image.closest("a"), oDataAttr = {};
            for (var i in oOptions) {
                oDataAttr[i] = $image.attr("data-magnify-" + i.toLowerCase());
            }
            var sZoomSrc = oDataAttr.src || oOptions.src || $anchor.attr("href") || "";
            if (!sZoomSrc) return;
            var $container, $lens, nImageWidth, nImageHeight, nMagnifiedWidth, nMagnifiedHeight, nLensWidth, nLensHeight, nBoundX = 0, nBoundY = 0, oContainerOffset, oImageOffset, getOffset = function() {
                        ...
                        "mousemove touchmove": function(e) {
                            ...
                            if ($lens.is(":visible")) {
                                ...
                                if (nMagnifiedWidth && nMagnifiedHeight) {
                                    var nRatioX = -Math.round(nX / nImageWidth * nMagnifiedWidth - nLensWidth / 2), nRatioY = -Math.round(nY / nImageHeight * nMagnifiedHeight - nLensHeight / 2);
                                    if (oOptions["limitBounds"]) {
                                        var nBoundRight = -Math.round((nImageWidth - nBoundX) / nImageWidth * nMagnifiedWidth - nLensWidth / 2), nBoundBottom = -Math.round((nImageHeight - nBoundY) / nImageHeight * nMagnifiedHeight - nLensHeight / 2);
        ...
        this.destroy = function() {
            this.each(function() {
                var $this = $(this), $lens = $this.prev("div.magnify-lens"), sStyle = $this.data("originalStyle");
